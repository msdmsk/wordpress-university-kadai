    <!-- get_header()：ヘッダー（heder.php）を部品として呼び出して表示 -->
    <?php get_header(); ?>
      ...
      <div class="footer_row">
        <div class="row news_row">
          ...
          <div class="col-lg-6 col-md-6 col-sx-12 news_col">
            ...
            <!-- ニュース一覧を表示：WordPressのループという仕組みを使用。ニュースカテゴリーの投稿を順番に取り出して一つずつ表示する -->
            <?php
            ...
            <!-- ループ処理 -->
            <!-- get～：直接echoするためではなく、PHP内でデータとして使える値を返す。(echo get〜のように使用) -->
            <!-- the～：データをHTMLに適切に書き出す。 -->
            ...
            <?php endforeach; ?>
            <!-- wp_reset_postdata()：使用した投稿データをリセット。ループ処理の後で実行する必要がある。ループとセットで利用 -->
          ...
          <div class="col-lg-6 col-md-6 col-sx-12 news_col">
            ...
            <!-- イベント一覧を表示：ニュースと同様のループと、投稿のタイトルや本文以外に別の情報を追加できるカスタムフィールドを設定する -->
            <!-- 投稿日ではなくイベントの開催日を表示する -->
            <?php
            $args = array(
              // 投稿タイプ
              'post_type' => 'post',
                ...
                <div class = "row news_post_row">
                  <div class = "col-lg-3 col-md-4 col-sx-12">
                    <div class = "calendar_border">
                      <div class = "calendar_border_1">
                        <!-- post_custom()関数：カスタムフィールドの情報を取得する。引数にカスタムフィールド名を指定する -->
                  ...
                  <div class = "col-lg-9 col-md-8 col-sx-12">
                    <div class = "news_post_small_title">
                      ...
                      <!-- wp_trim_words()：文字列を指定の文字数で切り取る。切り取った文字列の末尾に別の文字を付与できる。50文字を超えた場合は「...」を付け足す -->
                        <?php
    ...
    <div class="col-lg-6 col-md-6 col-sx-12 news_col">
            ...
            <!-- 卒業生の声一覧を表示：WordPressのループという仕組みを使用。ニュースカテゴリーの投稿を順番に取り出して一つずつ表示する -->
            <?php
            //取得したい投稿記事などの条件を引数として渡す
            $args = array(
              // 投稿タイプ
    ...
    <!-- get_footer()関数：フッター（footer.php）を部品として呼び出して表示 -->
    <?php get_footer(); ?>