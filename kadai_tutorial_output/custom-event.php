<!-- カスタムページテンプレート：ページの一部に表示方法やデザインのテンプレートを利用したいときに用いる -->
<!-- Template Name	カスタムページテンプレートの名前を設定する(コメントアウトする！) -->
<!-- Template Post Type	「投稿：post」「固定ページ：page」「カスタム投稿タイプ：タイプ名（course）」のいずれかを設定する -->
                        ...
                        <div class="col-lg-10 col-md-10 col-sx-12">
                          ...
                          <div class="news_time">
                            ...
                            <div>
                              ...
                              <span>参加費:
                                <!-- 参加費無料の場合は「無料」と表示し、それ以外の場合は「¥X,XXX」のように表示させる -->
                                <?php
